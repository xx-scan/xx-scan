# Generated by Django 2.1.7 on 2019-05-25 19:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('script', models.TextField(blank=True, verbose_name='完整的执行脚本')),
                ('active', models.BooleanField(default=False, verbose_name='记录是否被激活')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
            ],
            options={
