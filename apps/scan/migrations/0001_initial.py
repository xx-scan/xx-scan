# Generated by Django 2.1.7 on 2019-06-12 09:07

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import scan.models.scan_cfg
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('config_file', models.FileField(upload_to=scan.models.scan_cfg.config_directory_path, verbose_name='扫描文件')),
                ('name', models.CharField(blank=True, max_length=100, verbose_name='配置名字')),
                ('desc', models.TextField(default='', verbose_name='配置描述')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
            ],
            options={
                'verbose_name': '扫描方案上传',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exported', models.BooleanField(default=False, verbose_name='是否被导出')),
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('date_updated', models.DateTimeField(auto_now=True)),
            ],
            options={
